...
import de.hybris.merchandise.storefront.updateform.CustomUpdateProfileForm;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		updateProfileForm.setPostalCode(customerData.getPostalCode());
	...
	@RequireHardLogIn
	public String updateProfile(final CustomUpdateProfileForm updateProfileForm, final BindingResult bindingResult,
			final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		customerData.setPostalCode(updateProfileForm.getPostalCode());
