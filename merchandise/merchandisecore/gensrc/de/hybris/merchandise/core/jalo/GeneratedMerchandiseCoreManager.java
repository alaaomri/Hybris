 ...
 * --- Generated at 25 mars 2019 17:40:32                       ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
public abstract class GeneratedMerchandiseCoreManager extends Extension
{
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Customer.postalCode</code> attribute.
	 * @return the postalCode - Defines the Postal code for customer.
	 */
	public String getPostalCode(final SessionContext ctx, final Customer item)
	{
		return (String)item.getProperty( ctx, MerchandiseCoreConstants.Attributes.Customer.POSTALCODE);
	}
	 ...
	 * @return the postalCode - Defines the Postal code for customer.
	 */
	public String getPostalCode(final Customer item)
	{
		return getPostalCode( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Customer.postalCode</code> attribute. 
	 * @param value the postalCode - Defines the Postal code for customer.
	 */
	public void setPostalCode(final SessionContext ctx, final Customer item, final String value)
	{
		item.setProperty(ctx, MerchandiseCoreConstants.Attributes.Customer.POSTALCODE,value);
	}
	 ...
	 * @param value the postalCode - Defines the Postal code for customer.
	 */
	public void setPostalCode(final Customer item, final String value)
	{
